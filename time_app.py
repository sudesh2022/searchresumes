...
def load_data():
    with st.spinner(text="Loading and indexing the docs – hang tight! This should take 1-2 minutes."):
        ...
        service_context = ServiceContext.from_defaults(llm=OpenAI(model="gpt-3.5-turbo", temperature=0.5, system_prompt="Sudesh, Anthony, Jai, Ashoka, Naren, Manoj, Doyoung, Vijay are part of the team. Your job is to answer questions based on their profiles. Assume that all questions are related to the peoples information provided. Keep your answers short and  based on facts – do not hallucinate features."))
